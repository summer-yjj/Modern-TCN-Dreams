...
if __name__ == '__main__':
    ...
    elif args.task_name == 'point_segmentation':
        Exp = Exp_PointSeg
    else:
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            # 对 point_segmentation 任务，把 loss 配置拼进 setting 方便区分实验
            if args.task_name == 'point_segmentation':
                setting = setting + '_psloss{}_fg{}_dw{}'.format(
                    args.pointseg_loss, args.focal_gamma, args.dice_weight
                )
